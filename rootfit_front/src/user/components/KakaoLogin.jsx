...
const kakaoLogin = () => {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "10vh" }}>
      <button onClick={kakaoLogin}  style={{ backgroundImage: "url('/src/assets/img/kakao_login_large_wide.png')", backgroundSize: "cover", margin: "5px auto", width: "450px", height: "60px", border: "none" }}>
      </button>

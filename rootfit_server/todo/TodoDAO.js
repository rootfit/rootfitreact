...
const sql = {
  ...
  // loadOnlySelect: 'SELECT healthSelect FROM healthselectTBL WHERE user_id = ?;',
  ...
  // updateOnlySelect: 'UPDATE healthselectTBL SET healthSelect = ? WHERE user_id = ? AND datediff(createAT, now()) = 0;',
};
